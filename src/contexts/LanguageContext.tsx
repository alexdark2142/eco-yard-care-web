...
const translations = {
  en: {
    ...
    'contact.form.messagePlaceholder': 'Tell us about your needs, property size, or any special requirements...',
  ...
  fr: {
    ...
    'contact.form.messagePlaceholder': 'Parlez-nous de vos besoins, de la taille de votre propriété ou de toute exigence particulière...',
  ...
  uk: {
    ...
    'contact.form.messagePlaceholder': 'Розкажіть нам про ваші потреби, розмір власності або будь-які спеціальні вимоги...',
